...
$('#my-face').parallax("0%", 0, 0.4, true);
	$('#lab').parallax("100%", 0, 0.1, true);
	$('#outer-ring').parallax("0%", 2500, 0.6, true);
	$('#middle-ring').parallax("0%", 2500, 0.6, true);
	$('#third').parallax("50%", 2750, 0.3, true);
	$('#about-box').parallax("50%", 2750, 0.3, true);
