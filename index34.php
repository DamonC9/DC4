...
<div class="outer_container">
  <div class="toolbar" style="position: fixed;">
    <div class="resume_btn"> <a href="resume.html" id="resume_btn"></a><!-- end #resume_btn --> 
      <img style="position: relative; top: 15px; left: 5px;" src="images/etch.png" alt=""> 
      </div><!-- end .resume_btn -->
    <div class="contact_btn"> <img style="position: relative; top: 12px; right: 50px;  float: right;" src="images/etch.png" alt=""> <a id="contact_btn" href="contact.php"></a> 

      </div><!-- end .contact_btn -->
    <div class="current">
      <ul>
        <li class="menu" id="home-tab"><a href="#home_container">Home</a></li>
        <li class="menu" id="about-tab"><a href="#about_container" >About</a></li>
        <li class="menu" id="interface-tab"><a href="#interface_container">Interface</a></li>
  ...
  <div class="home_container" id="home_container">
    ...
    <div id="home_nav">
      ...
      <div id="nav_lines">
        ...
        <h3 id="nav_about" class="x_nav"><a href="#about_container" >About</a></h3>
        <h3 id="nav_interface" class="x_nav"><a href="#interface_container">Interface</a></h3>
  ...
  <div id="about_container">
    <div id="my-face"><img src="images/my-face.jpg" alt="Damon Carlstrom"></div>
    ...
    <div id="lab"><img src="images/lab.jpg" alt=""></div>
    <div class="info-box" id="about-box">
      <div class="info-control"> 
        <!-- end .info-control --></div>
      <div class="button-area">
        <div class="open-close-btn" id="oc_about"></div>
        <!-- end #open-close-btn -->
        <p>Click to open</p>
      </div>
      <!-- end .button-area -->
    ...
    <div class="info-box" id="interface-box">
      ...
      <p class="info-title">Something about interface</p>
     
   
      <!-- end .info-box --></div>
    <!-- end #interface_container --></div>
  <div class="content"> 
...
<script type="text/javascript">
		...
		$("#slide2").slideUp(1).delay(5000).slideDown('slow').delay(5000).slideUp('slow').delay(5000);
		$("#slide3").slideUp(1).delay(11000).slideDown('slow').delay(5000).slideUp('slow');
		$("#slide4").slideUp(1).delay(17000).slideDown('slow').delay(5000).slideUp('slow').delay(5000);
		$("#slide5").slideUp(1).delay(23000).slideDown('slow').delay(5000).slideUp('slow').delay(5000);
		$("#slide6").slideUp(1).delay(29000).slideDown('slow').delay(5000).slideUp('slow').delay(5000);
		$("#slide7").slideUp(1).delay(35000).slideDown('slow').delay(5000).slideUp("slow" , slide);
		
			}));	
			
			/***** About box animation *******/
		$("#oc_about").click(function () {
			$(this).fadeOut("fast").addClass("invert").fadeIn("fast" , function () {
			$("#about-box").animate({height:"2000px" , paddingTop: "500px", marginTop: "-500px"}, 500);
				});
		});//Extends info box area to top of container
		
		/*$("#oc_about").click(function () {
			$(this).fadeOut("fast").addClass("invert").fadeIn("fast" , function () {
			$("#about-box").animate({height:"2000px" , paddingTop: "500px", marginTop: "-500px"}, 500);
				}); 
		});//Retracts info box area back to content
		
		
		/* Scrolls sections to top as button is clicked */
		$("#oc_about").click(function () {
			$('html, body').animate({
		...
		$("#nav_resume a").pageslide(); 
		$("#contact_btn").pageslide({ direction: "left", modal: false });
		$("#nav_contact a").pageslide({ direction: "left", modal: false });
    ...
    $('#interface-tab').click(function(){
    	$('html, body').animate({
    		scrollTop:$('#interface_container').offset().top
    	}, 1000, function() {
	    	parallaxScroll(); // Callback is required for iOS
		});
    	return false;
...
function parallaxScroll(){
	...
	$('#my-face').css('top',(200-(scrolled*.05))+'px');
	$('#outer-ring').css('top',(420-(scrolled*.20))+'px');
	$('#middle-ring').css('top',(420-(scrolled*.20))+'px');
	$('#inner-ring').css('top',(420-(scrolled*.20))+'px');
	$('#vertical-scale').css('top',(550-(scrolled*.45))+'px');
	$('#target').css('top',(850-(scrolled*.75))+'px');
	$('#about-box').css('top',(850-(scrolled*.75))+'px');
	$('#lab').css('top',(300-(scrolled*.05))+'px');
}
