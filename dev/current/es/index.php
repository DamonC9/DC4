...
<div class="outer_container">
  <div class="toolbar" style="position: fixed;">
    ...
    <nav class="current">
      <ul>
        <li class="menu" id="home-tab"><a href="#home">Casa</a></li>
        <li class="menu" id="about-tab"><a href="#about" >Sobre</a></li>
        <li class="menu" id="interface-tab"><a href="#interface">Interfaz</a></li>
        <li class="menu" id="animation-tab"><a href="#animation">Animación</a></li>
        <li class="menu" id="concepts-tab"><a href="#campaigns">Conceptos</a></li>
        <li class="menu" id="print-tab"><a href="#print">Impreso</a></li>
        <li class="menu" id="art-tab"><a href="#art">Arte</a></li>
      </ul>
    </nav>
    <!-- end .nav --> 
    ...
    <div id="home_nav">
      ...
      <div id="name_slide">
        <div id="slide1" style="position: absolute; right: 0px; top: 0px;overflow:hidden;">
          <h3 style="color: #7fb1c8; background-color: black;">Interfaz de Usuario Especialista</h3>
        </div>
      ...
      <div id="nav_lines">
        <h3 id="nav_resume" class="x_nav"><a href="resume.html">CV</a></h3>
        <h3 id="nav_contact" class="x_nav"><a href="contact.php">Contacto</a></h3>
        <h3 id="nav_about" class="x_nav"><a href="#about" >Sobre</a></h3>
        <h3 id="nav_interface" class="x_nav"><a href="#interface">Interfaz</a></h3>
        <h3 id="nav_animation" class="x_nav"><a href="#animation">Animación</a></h3>
       <h3 id="nav_concepts" class="x_nav"><a href="#concepts">Conceptos</a></h3>
        <h3 id="nav_print" class="x_nav"><a href="#print">Impreso</a></h3>
        <h3 id="nav_art" class="x_nav"><a href="#art">Arte</a></h3>
      </div>
      <!-- end .nav_lines --> 
    </div>
    <!-- end .home_nav -->
