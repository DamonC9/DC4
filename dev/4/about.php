<div id = "aboutOuter" class = "containerBlock" >
<div id="about" >
  <div class="modal2" id="modal-process">
    ...
    <div id="lab"></div>
	<div id = "about-box-container" style="right: 14%; position: absolute; bottom: 200px">
	<div id = "about-box-anchor"></div>
    <div class="info-box infoStick" id="about-box" style = "position: relative;">
