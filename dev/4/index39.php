  ...
  <div id="interface">
    <div class="info-box" id="interface-box">
      <div class="info-control"> 
        <!-- end .info-control --></div>
      <div class="button-area">
        <div class="open-close-btn" id="oc_interface"></div>
        <!-- end #open-close-btn -->
        <p>Click to open</p>
      </div>
      <!-- end .button-area -->
    ...
    <div id="animation">
    <div id="jungle-bg"><img src="images/jungle-back.jpg" alt=""></div>
    <div id="branch"><img src="images/branch.png" alt=""></div>
     ...
     <div class="info-box" id="animation-box">
      ...
      <p class="info-title">After Effects & Cinema4D Animations</p>
    </div><!-- end #animation -->
  <div class="content"> 
...
function parallaxScroll(){
	...
	$('#lab').css('top',(300-(scrolled*.00))+'px');
	
	//Interface Scrolling
	$('#interface-box').css('top',(1650-(scrolled*.75))+'px');
}
